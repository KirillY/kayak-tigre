...
function initIndex() {
  ...
  index.add(
      ...
      
      {
        ...
        content: "¡Bienvenidos a nuestro blog de aventuras en kayak! Descubre las mejores rutas y experiencias inolvidables en el Delta del Tigre. Nuestros guías expertos compartirán consejos e historias para ayudarte a comenzar tu viaje en el mundo del kayak.\nView this post on Instagram A post shared by Olga Ivleva (@ivleva.guide)"
      })
      .add(
      ...
      
      {
        id: 1,
        tag: "es",
        href: "/es/services/delta-full-day/",
        title: "Delta Full Day Experience",
        description: "Rutas en kayak y SUP en el corazón del delta del río",
        
        
        content: "📍Tigre\nSumérgete en un mundo de exuberante naturaleza salvaje donde la gente vive sobre el agua. Aquí no hay carreteras, solo una red infinita de arroyos y canales. Ante ti se encuentra el delta del segundo río más grande de Sudamérica: el Paraná.\n¿Por qué elegir nuestro tour? \u0026nbsp; Desde el muelle central de la ciudad, nos dirigiremos a islas remotas y arroyos forestales tranquilos, lejos del ruido y la navegación agitada del centro turístico de Tigre, lo cual es especialmente importante para principiantes en kayak y participantes con niños. Te recibiremos en un bote privado, y el crucero fluvial hasta nuestra base está incluido en el precio del tour.\nTambién preparamos un abundante desayuno con panqueques rusos, varios aperitivos, frutas y café recién hecho en todos nuestros programas.\nLos fines de semana, realizamos dos programas principales: el tour largo en kayak \u0026ldquo;Esperita\u0026rdquo; (día completo) y el tour corto \u0026ldquo;Torito\u0026rdquo; (medio día), donde también puedes elegir SUP. Los nombramos en honor a los hermosos arroyos por donde pasan estas rutas.\nEntre semana, puedes reservar un tour privado.\nEsperita. Cien Vueltas del Río. \u0026nbsp; 🕙 10:00 - 19:00\nUna inmersión completa en la naturaleza, lugares únicos. Navegaremos en kayak por cuatro ríos diferentes, desembarcaremos en una plaza festiva isleña y cruzaremos la isla por un sendero a través de la selva. Al final, visitaremos la casa-museo del Presidente Sarmiento, rodeada por un enorme cubo de vidrio. 🛶 Navegación por estrechos arroyos forestales 11 km, ~3 horas en el agua 🏃 Caminata por la isla a través de la selva hasta la casa-museo del Presidente Sarmiento, ~1 hora de caminata"
      })
      ;
