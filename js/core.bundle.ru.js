...
function initIndex() {
  ...
  index.add(
      ...
      
      {
        ...
        content: "Добро пожаловать в наш блог о приключениях на каяках! Откройте для себя лучшие маршруты и незабываемые впечатления в дельте Тигре. Наши опытные гиды поделятся советами и историями, которые помогут вам начать свое путешествие в мире каякинга.\nView this post on Instagram A post shared by Olga Ivleva (@ivleva.guide)"
      })
      ;
